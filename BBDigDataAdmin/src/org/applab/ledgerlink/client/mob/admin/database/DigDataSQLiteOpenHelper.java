 ...
 * </p>
 */
public abstract class DigDataSQLiteOpenHelper {
    private static final String t = DigDataSQLiteOpenHelper.class.getSimpleName();
     ...
     */
    public DigDataSQLiteOpenHelper(String path, String name, CursorFactory factory, int version) {
        if (version < 1)
    ...
    public synchronized SQLiteDatabase getWritableDatabase() {
        ...
        try {
            ...
            Log.d("CURRENT VERSION", String.valueOf(version));
            Log.d("NEW VERSION", String.valueOf(mNewVersion));
            ...
            if (success) {
                if (mDatabase != null) {
                    try {
                        ...
                        Log.e("DDSQLiteHelper", e.toString());
                    }
                    // mDatabase.unlock();
                }
                mDatabase = db;
