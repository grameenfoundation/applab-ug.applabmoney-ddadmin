...
public class GetVslasTask extends AsyncTask<String, Void, Integer> {
    ...
    public GetVslasTask(LoginActivity activity, ProgressDialog progressDialog) {
    ...
    protected Integer doInBackground(String... arg0) {
        ...
        try {
         ...
         /*   BufferedReader rd = new BufferedReader(new InputStreamReader(
            ...
            responseCode = 408;
            e.printStackTrace();
            Log.i("GetVslas", e.getMessage().toString());
        }
        return responseCode;
    }
    ...
    protected void onPostExecute(Integer headerCode) {
        ...
        Log.i("GetVslasTask", headerCode.toString());
        if (headerCode == 200) {
            activity.postLoginListVslas(json);
        } else {
